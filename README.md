...
<table>
  <tr>
    <td valign="top" width="50%">
      <strong>Stock Data Analysis &amp; Visualization Platform</strong><br />
      Django-based stock market analysis platform using Supabase, yfinance, and OTP authentication through Google SMTP.<br /><br />
      <strong>Stack:</strong> Django, PostgreSQL, Supabase, yfinance, SMTP
    </td>
    <td valign="top" width="50%">
      <strong>QuickQR</strong><br />
      Responsive QR code generator with URL validation, instant generation, download support, history tracking, and dark/light mode.<br /><br />
  ...
  <tr>
    <td valign="top" width="50%">
      ...
      Ongoing autonomous reasoning agent focused on planning, tool execution, and real-world system interaction using local LLMs and automation frameworks.<br /><br />
      <strong>Stack:</strong> Python, local LLMs, automation frameworks
    </td>
    <td valign="top" width="50%">
      <strong>Plants World</strong><br />
      Plant e-commerce UI with product listings, categories, gallery views, and form interfaces. Live project available below.<br /><br />
      <strong>Stack:</strong> Figma, HTML, CSS, JavaScript<br />
